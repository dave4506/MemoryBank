...
class CreateEventViewController: UIViewController, UITextFieldDelegate {
    ...
    func textFieldShouldReturn(eventNameField textField: UITextField) -> Bool {
        textField.resignFirstResponder()
        return true
    }
    
    func textFieldShouldReturn(descripField textField: UITextField) -> Bool {
        textField.resignFirstResponder()
        return true
    }
    
    func textFieldShouldReturn(startTimeField textField: UITextField) -> Bool {
        textField.resignFirstResponder()
        return true
    }
    
    func textFieldShouldReturn(endTimeField textField: UITextField) -> Bool {
        textField.resignFirstResponder()
        return true
    }
    
    func textFieldShouldReturn(locationField textField: UITextField) -> Bool {
        textField.resignFirstResponder()
        return true
    }
