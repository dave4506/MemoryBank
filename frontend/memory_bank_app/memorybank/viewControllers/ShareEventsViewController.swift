//
//  ShareEventsViewController.swift
//  memorybank
//
...
class ShareEventsViewController: UIViewController, UITextFieldDelegate {
    ...
    func textFieldShouldReturn(eventIDField textField: UITextField) -> Bool {
        textField.resignFirstResponder()
        return true
    }
    
    func textFieldShouldReturn(userEmailField textField: UITextField) -> Bool {
        textField.resignFirstResponder()
        return true
    }
