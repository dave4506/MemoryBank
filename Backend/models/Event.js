...
class Event {
  constructor(_creator_username, _creator_id, _event_name, _event_description, _event_location, _event_start_time, _event_end_time) {
      ...
      this.evet_start_time = _event_start_time;
